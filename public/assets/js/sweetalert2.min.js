! function (e, t) {
    ...
    var I = function (e) {
            for (var t in e) K.isValidParameter(t) || a('Unknown parameter "' + t + '"'), K.isDeprecatedParameter(t) && function (e) {
        ...
        D = function (t) {
            ...
            if (t.titleText ? A.innerText = t.titleText : A.innerHTML = t.title.split("\n").join("<br />"), t.backdrop || P(document.body, o["no-backdrop"]), t.text || t.html) {
                if ("object" === N(t.html))
                    if (B.innerHTML = "", 0 in t.html)
                        for (var M = 0; M in t.html; M++) B.appendChild(t.html[M].cloneNode(!0));
            ...
            t.showCloseButton ? (j.setAttribute("aria-label", t.closeButtonAriaLabel), q(j)) : V(j), n.className = o.popup, t.toast ? (P(document.body, o["toast-shown"]), P(n, o.toast)) : P(n, o.modal), t.customClass && P(n, t.customClass);
            var R = v(),
                D = parseInt(null === t.currentProgressStep ? K.getQueueStep() : t.currentProgressStep, 10);
            t.progressSteps.length ? (q(R), function (e) {
                for (; e.firstChild;) e.removeChild(e.firstChild)
            }(R), D >= t.progressSteps.length && a("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(function (e, n) {
            ...
            if (t.type) {
                ...
                if (q(Q), t.animation) switch (t.type) {
                    case "success":
        ...
        K = function e() {
            ...
            return new Promise(function (t, n) {
                var r = function (n) {
                        e.closePopup(a.onClose), t(a.useRejections ? n : {
                            value: n
                        })
                    },
                    l = function (o) {
                ...
                for (var H = function (t) {
                    ...
                    }, I = m.querySelectorAll("button"), K = 0; K < I.length; K++) I[K].onclick = R, I[K].onmouseover = R, I[K].onmouseout = R, I[K].onmousedown = R;
                k().onclick = function () {
                    l("close")
                ...
                var Y = function (e, t) {
                    ...
                    _ = function (t) {
                        ...
                        } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(n.key) ? document.activeElement === Z && O(Q) ? Q.focus() : document.activeElement === Q && O(Z) && Z.focus() : "Escape" !== n.key && "Esc" !== n.key || !0 !== a.allowEscapeKey || l("esc")
                    };
                window.onkeydown && window.onkeydown.toString() === _.toString() || (u.previousWindowKeyDown = window.onkeydown, window.onkeydown = _), a.buttonsStyling && (Z.style.borderLeftColor = a.confirmButtonColor, Z.style.borderRightColor = a.confirmButtonColor), e.hideLoading = e.disableLoading = function () {
                    ...
                    V(v())
                }, e.enableButtons(), e.hideLoading(), e.resetValidationError(), a.input && P(document.body, o["has-input"]);
                ...
                "select" !== a.input && "radio" !== a.input || (a.inputOptions instanceof Promise ? (e.showLoading(), a.inputOptions.then(function (t) {
                    ...
                    function (e, t, n) {
                        var r = p(),
                            i = f();
                        null !== t && "function" == typeof t && t(i), e ? (P(i, o.show), P(r, o.fade), L(i, o.hide)) : L(i, o.fade), q(i), r.style.overflowY = "hidden", j && !B(i, o.noanimation) ? i.addEventListener(j, function e() {
                            i.removeEventListener(j, e), r.style.overflowY = "auto"
                        }) : r.style.overflowY = "auto", P(document.documentElement, o.shown), P(document.body, o.shown), P(r, o.shown), A() && (U(), W()), u.previousActiveElement = document.activeElement, null !== n && "function" == typeof n && setTimeout(function () {
                            n(i)
                        })
                    }(a.animation, a.onBeforeOpen, a.onOpen), a.toast || (a.allowEnterKey ? a.focusCancel && O(Q) ? Q.focus() : a.focusConfirm && O(Z) ? Z.focus() : Y(-1, 1) : document.activeElement && document.activeElement.blur()), p().scrollTop = 0
            })
        };
    return K.isVisible = function () {
        ...
        return new Promise(function (e, o) {
            ! function r(i, a) {
                i < R.length ? (document.body.setAttribute("data-swal2-queue-step", i), K(R[i]).then(function (e) {
                    n.push(e), r(i + 1, a)
                }, function (e) {
                    t(), o(e)
                })) : (t(), e(n))
        ...
        var t = p(),
            n = f();
        if (n) {
            L(n, o.show), P(n, o.hide), clearTimeout(n.timeout), document.body.classList.contains(o["toast-shown"]) || function () {
            ...
            var r = function () {
                t.parentNode && t.parentNode.removeChild(t), L(document.documentElement, o.shown), L(document.body, o.shown), L(document.body, o["no-backdrop"]), L(document.body, o["has-input"]), L(document.body, o["toast-shown"]), A() && (null !== u.previousBodyPadding && (document.body.style.paddingRight = u.previousBodyPadding, u.previousBodyPadding = null), function () {
    ...
    }, K.noop = function () {}, K.version = "7.0.0", K.default = K, K
