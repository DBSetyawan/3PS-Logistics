! function () {
    ...
    */
    ...
    function E(n) {
        this.H = RegExp(" "), this.C = "", this.m = new e, this.w = "", this.i = new e, this.u = new e, this.l = !0, this.A = this.o = this.F = !1, this.G = x.b(), this.s = 0, this.b = new e, this.B = !1, this.h = "", this.a = new e, this.f = [], this.D = n, this.J = this.g = I(this, this.D)
    }
    ...
    function R(n, t) {
        ...
        if (!n.l) {
            if (!n.F)
                if (P(n)) {
                    if (q(n)) return F(n)
                } else if (0 < n.h.length && (e = n.a.toString(), l(n.a), n.a.a(n.h), n.a.a(e), e = n.b.toString(), r = e.lastIndexOf(n.h), l(n.b), n.b.a(e.substring(0, r))), n.h != H(n)) return n.b.a(" "), F(n);
            return n.i.toString()
        }
        switch (n.u.b.length) {
            case 0:
            ...
            case 3:
                ...
                n.A = !0;
            default:
                return n.A ? (q(n) && (n.A = !1), n.b.toString() + n.a.toString()) : 0 < n.f.length ? (e = T(n, t), r = C(n), 0 < r.length ? r : (D(n, n.a.toString()), B(n) ? G(n) : n.l ? M(n, e) : n.i.toString())) : V(n)
        }
    }
    ...
    function V(n) {
        ...
        if (3 <= t.length) {
            for (var e = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
                var i = e[r];
                0 < n.h.length && A(g(i, 4)) && !h(i, 6) && null == i.a[5] || (0 != n.h.length || n.o || A(g(i, 4)) || h(i, 6)) && fn.test(g(i, 2)) && n.f.push(i)
            }
            return D(n, t), t = C(n), 0 < t.length ? t : B(n) ? G(n) : n.i.toString()
        }
        return M(n, t)
    }
    ...
    function q(n) {
        ...
        return 0 != t && (l(n.a), n.a.a(r.toString()), r = j(t), "001" == r ? n.g = N(n.G, "" + t) : r != n.D && (n.g = I(n, r)), n.b.a("" + t).a(" "), n.h = "", !0)
    }
    ...
    var X = /^-?[0-9]+$/;
    t($, S), $.prototype.a = function (n, t) {
        var e = new n.b;
        return e.g = this, e.a = t, e.b = {}, e
    }, t(w, $), w.prototype.b = function (n, t) {
    ...
    */
    ...
    E.prototype.K = function () {
        this.C = "", l(this.i), l(this.u), l(this.m), this.s = 0, this.w = "", l(this.b), this.h = "", l(this.a), this.l = !0, this.A = this.o = this.F = !1, this.f = [], this.B = !1, this.g != this.J && (this.g = I(this, this.D))
