(function (c) {
    var i = {
            init: function (a) {
                ...
                b.repeat !== !0 && !isNaN(b.repeat) && b.repeat > 0 && (b.repeat -= 1);
        ...
        g = function (a, b, d) {
            ...
            a.glow ? (e["box-shadow"] = "0px 0px " + parseInt(d / 1.5) + "px " + h, c.browser.webkit && (e["outline-offset"] = d + "px",
                e["outline-radius"] = "100 px")) : e["outline-offset"] = d + "px";
            c(b).css(e);
            b.timer = setTimeout(function () {
                if (d >= f && !a.repeat) return c(b).pulsate("destroy"), !1;
                else if (d >= f && a.repeat !== !0 && !isNaN(a.repeat) && a.repeat > 0) a.repeat -= 1;
                else if (a.pause && d >= f) return j(a, b, d + 1), !1;
                g(a, b, d + 1)
            }, a.speed / f)
        },
        j = function (a, b, c) {
    ...
    c.fn.pulsate = function (a) {
        ...
        else if (typeof a === "object" || !a) return i.init.apply(this,
            arguments);
        else c.error("Method " + a + " does not exist on jQuery.pulsate")
    }
})(jQuery);