...
<head>
	...
	<link rel="shortcut icon" href="{{ asset('img/error-en.png') }}">
	<title>System error Encountered - {{ config('app.name') }}</title>
			...
			<div class="container mx-auto px-4">
				<div class="flex items-center justify-between py-4">
					...
					<div class="hidden sm:flex cursor-pointer sm:items-center">
						<a href="#LiveTracking"
                            class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1 tracking-tight">
                        </a>
                        <span class="font-semibold mr-2 text-left flex-auto">Sedang terjadi kesalahan sistem, coba untuk menghubungi developer dengan mengklik tombol</span><span class="flex rounded-full bg-red-500 uppercase px-2 py-1 text-xs font-bold mr-3">Error</span>
		...
		<div class=" flex flex-col items-center flex-1 h-full justify-center py-12 px-3">
			{{-- {{ $geocode }} --}}
				<div class="w-full w-px rounded-full empty-state">
                    {{--  <div class="relative h-95 p-4">  --}}
                        <br/>
                        <div class="md:flex">
                            <div class="md:flex-shrink-0">
                                <img class="rounded-lg md:w-75" src="{{ asset('img/HANDLE-SYSTEM.png') }}" alt="Woman paying for a purchase">
                            </div>
                            <div class="mt-4 md:mt-20 md:ml-16">
