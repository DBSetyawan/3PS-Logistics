            ...
            <div class="span12">
                ...
                <div class="widget blue">
                    ...
                    <div class="widget-body">
                      ...
                      @endif
                        <!-- BEGIN FORM-->
                        <form action="{{url('vehicle_accociate')}}" class="form-horizontal" method="POST">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="registrationNumberPlate" value="{{ old('project_name') }}" class="span12 " />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" maxlength="30" name="nameOfOwner" value="{{ old('nameOfOwner') }}" class="span12 " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="ownerAddress" value="{{ old('ownerAddress') }}" class="span12 " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" maxlength="4" id="manufactureYear" name="manufactureYear" value="{{ old('manufactureYear') }}" class="span12 " />
                                                </div>
                                            </div>
                                        </div>
                                    <div class="span6">
                                        ...
                                        <div class="controls">
                                            <input type="text" maxlength="30" name="vehicleIdentificationNumber" value="{{ old('vehicleIdentificationNumber') }}" class="span12 " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" maxlength="30" name="cylinderCapacity" value="{{ old('cylinderCapacity') }}" id="tax_no" class="span12" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" maxlength="30" name="brand" value="{{ old('brand') }}" class="span12 " />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" maxlength="30" name="engineNumber" value="{{ old('engineNumber') }}" class="span12" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" maxlength="30" name="type" value="{{ old('type') }}" class="span12" />
                                                </div>
                                            </div>
                                        </div>
                                    {{-- <div class="span6">
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" maxlength="30" name="model" value="{{ old('model') }}" class="span12" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" maxlength="4" id="registrationYear" name="registrationYear" value="{{ old('registrationYear') }}" class="span12" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="vehicleOwnershipDocumentNumber" value="{{ old('vehicleOwnershipDocumentNumber') }}" class="span12" />
                                                </div>
                                            </div>
                                        </div>
                                    {{-- <div class="span6">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="licensePlateColor" name="licensePlateColor" value="{{ old('licensePlateColor') }}" class="span12" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                        <div class="span6">
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="typeFuel" name="typeFuel" value="{{ old('typeFuel') }}" class="span12" />
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="locationCode" name="locationCode" value="{{ old('locationCode') }}" class="span12" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="registrationQueNumber" value="{{ old('registrationQueNumber') }}"  class="span12" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span6">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <input id="dateOfExpire" name="dateOfExpire" type="text" class="m-ctrl-medium" />
                                                    </div>
                                                </div>
                                                    {{-- <div class="controls">
                            ...
                            <div class="row-fluid">
                                    <div class="span12" style="text-align:right;" >
                                        ...
                                        <a class="btn btn-warning" href="{{ url('/vehicle-list') }}">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
