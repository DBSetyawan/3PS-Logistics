@extends('admin.layouts.master', array('redirects_whs' => session()->get('redirects_to_whs')))
@section('head')
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        {{-- class -> customer_names for select2 data customer name  --}}
                                                        <select class="form-control" id="customers_name" style="width:329px;" name="customers_name" disabled>
                                                            <option value="{{$customerorders->id}}"
                                                                selected="{{$customerorders->name}}">
                                                                {{$customerorders->name}}
                                                            </option>
                                                        </select>
                                                        <div class="row-fluid">
                                                            ...
                                                            <div class="span6">
                                                                ...
                                                                <div class="controls">
                                                                    <div class="input-prepend">
                                                                        ...
                                                                        <input id="start_date" name="start_date" type="text" class="m-ctrl-medium" />
                                                                    </div>
                                                                  </div>
                                                                </div>
                                                            <div class="span4">
                                                                <div class="control-group">
                                                                    ...
                                                                    {{-- <div class="controls"> --}}
                                                                        <div class="input-prepend">
                                                                            <span class="add-on"><i class="icon-calendar"></i></span>
                                                                            <input id="end_date" name="end_date" type="text" class="m-ctrl-medium" />
                                                                        </div>
                                                                {{-- </div> --}}
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row_fluid">
                                                        <div class="span4">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" maxlength="20" id="contract_no" name="contract_no"
                                                                            style="width:260%">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row-fluid">
                                                            <div class="span12">
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <textarea class="span12" id="remark" name="remark" rows="3"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row-fluid">
                                                                <div class="span12">
                                                                    <div class="control-group">
                                                                        <label class="control-label" style="font-family: 'Courier', monospace;font-size:15px;font: bold;"> <strong>Informasi WOM</strong></label>
                                                                        <div class="controls">
                                                                            <hr>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="row-fluid">
                                                                <div class="span3">
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input type="text" maxlength="5" id="volume" name="volume" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    <div class="span7">
                                                                        <div class="control-group">
                                                                            <div class="controls">
                                                                                <select class="input-small m-wrap popovers" data-trigger="hover" data-content="Data WOM" data-original-title="Information" id="uom" name="uom">
                                                            ...
                                                            <div class="row-fluid">
                                                                    <div class="span3">
                                                                                <div class="control-group">
                                                                                        <label class="control-label">Rate Price</label>
                                                                                        <div class="controls">
                                                                                            <div class="input-prepend input-append">
                                                                                                <span class="add-on">Rp</span><input type="text" maxlength="17" id="rate" name="rate" style="width;248%"
                                                                                                required>
                                                                                            </div>
                                                                                        </div>
                                                                                {{-- @if ($errors->has('rate')) --}}
                                                                            ...
                                                                            <div class="control-group">
                                                                                <div class="controls">
                                                                                    <input readonly="enabled"
                                                                                        type="text" maxlength="30" id="total_rate" name="total_rate" style="width;130px" >
                                                                                    </div>
                                                                            {{-- @if ($errors->has('total_rate')) --}}
                                                                                {{-- <span class="alert alert-danger span12" style="width:230px;text-align: center">{{$errors->first('total_rate')}}</span> --}}
                                                                            {{-- @endif --}}
                                                                      </div>
                                                                </div>
        ...
        $(document).ready(function () {
            $("#rate").keyup(function (data) {
                ...
                if (isNaN(result_rate))
                    ...
                    document.getElementById('total_rate').value = (((sign) ? '' : '') + 'Rp. ' + result_rate + '');
