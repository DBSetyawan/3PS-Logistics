       ...
       <div class="row-fluid">
            ...
            <div class="widget red">
                ...
                <div class="widget-body">
                  ...
                  <a class="btn btn-info" href="{{url('customer')}}">Back to Customer</a>
                    <div>
                        &nbsp;
                    </div>
                    ...
                    <table class="table table-striped table-bordered" id="sample_1">
                        ...
                        <tbody>
                          ...
                          <tr class="odd gradeX">
                              ...
                              <td style="width: 5%;">{{$list->customer_id}}</td>
                              ...
                              <td style="width: 20px;"><span class="label label-inverse">{{$list->cstatusid->status}}</span></td>
                              <td style="width: 20px;">
