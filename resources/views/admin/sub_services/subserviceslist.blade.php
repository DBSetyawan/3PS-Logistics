       ...
       <div class="row-fluid">
            ...
            <div class="widget red">
                ...
                <div class="widget-body">
                    ...
                    <table class="table table-striped table-bordered" id="sample_1">
                        ...
                        <tbody>
                          @foreach($sub_service as $item_rows)
                            <tr class="odd gradeX">
                                <td style="width: 6%;">{{ $item_rows->id }}</td>
                                <td style="width: 26%;">{{ $item_rows->name }}</td>
                                <td style="width: 13%;">{{ $item_rows->service->name }}</td>
                                <td style="width: 30%;">{{ $item_rows->companys->name }}</td>
                                <td style="width: 18%;">{{ $item_rows->remark }}</td>
                                <td style="width: 7%;">{{ $item_rows->prefix }}</td>
                                {{-- <td style="width: 30%;">{{ $item_rows->users['name'] }}</td> --}}
                                {{-- <td style="width: 60px;">
                                ...
                                <td style="width: 120px;">
                                        <a href="{{ route('show.sub_services.list', array($some, $encrypts)) }}"><button class="btn btn-primary"><i class="icon-pencil"></button></i></a>
                                  </td>
                            </tr>
                          @endforeach()
                        </tbody>
        ...
        <div class="modal fade" id="add_item" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="add_item" method="post" action="{{url('subservice')}}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" class="span12 " />
                        <br />
                        <div class="control-group">
                            <label class="control-label" style="text-align: end">Sub service name</label>
                            <div class="controls">
                                <input class="input-large" type="text" maxlength="30" name="itemid" />
                            </div>
                        </div>
                        {{-- <div class="control-group">
                            <label class="control-label" style="text-align: end">Sub Services</label>
                            <div class="controls">
                                <select class="input-large m-wrap" style="width:224px" tabindex="1" id="compan" name="compan">
                            </select>
                        </div>
                    </div> --}}
                    <div class="control-group">
                            ...
                            <div class="controls">
                                <select class="input-large m-wrap" style="width:224px" tabindex="1" id="service" name="service">
                            </select>
                        </div>
                    </div>
                        <div class="control-group">
                            <label class="control-label" style="text-align: end">Remark</label>
                                <div class="controls">
                                    <input class="input-large" type="text" maxlength="30" name="remark" />
                        ...
                        {{-- <div class="control-group">
                            ...
                            <div class="controls">
                            <input class="input-large" type="text" maxlength="30" name="prefix" />
                                {{-- <span class="help-inline">Some hint here</span> --}}
                        {{-- </div>
                    </div> --}}
                </div>
