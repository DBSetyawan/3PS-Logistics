            ...
            <div class="span12">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> {{ $details_pics->vendor->company_name }}</h4>
                        <span class="tools">
                    ...
                    <div class="widget-body">
                      ...
                      @endif
                        <!-- BEGIN FORM-->
                        <!-- <?php var_dump($vp->id); ?> -->
                        <form action="{{route('vendorpics.update', $vp->id)}}" class="form-horizontal" method="POST">
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" maxlength="30" value="{{$tablevpc->name}}" name="name_customer" class="span12"></input>
                                        </div>
                                    </div>
                                </div>
                                </div>
                                        ...
                                        <div class="controls">
                                          <select class="span12 chzn-select" name="vendor_pic_status_customer" style="width:100px" data-placeholder="Status" tabindex="1">
                                            @foreach($vstatus as $a)
                                              <option value="{{ $a->id }}"  @if($a->id==$tablevpc->vendor_pic_status_id) selected='selected' @endif >{{ $a->name }}</option>
                                              @endforeach()
                                          </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" maxlength="30" value="{{$tablevpc->position}}" name="position_customer" class="span12" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <div class="input-prepend">
                                                  <span class="add-on">@</span><input type="text" maxlength="30" style="width:160%;" value="{{$tablevpc->email}}" name="email_customer" class="span12" />
                                              </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row-fluid">
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" maxlength="15" id="tax_phone" value="{{$tablevpc->phone}}" name="phone_customer" class="span12" />
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                    <div class="row-fluid">
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" maxlength="15" id="tax_fax" value="{{$tablevpc->mobile_phone}}" name="mobile_phone_customer" class="span12" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
