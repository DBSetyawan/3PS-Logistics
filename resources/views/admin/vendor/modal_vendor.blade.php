<body onload="LoaderLoading()">
    <div class="modal fade" id="add_vendor" data-keyboard="false" data-backdrop="static" tabindex="-1"
        role="dialog" aria-labelledby="Add Vendor" aria-hidden="true" aria-hidden="true" 
        style="margin:-25px -625px;width:1260px;height:698px;overflow: auto;pointer-events:none;display: none">
            <div class="modal-header">
                <pre><h3 id="LabelCustomer">Add Vendor</h3></pre>
            </div>
            <div id="loader"></div>
                ...
                {{-- <div class="row-fluid">
                    ...
                    <div class="row-fluid">
                                ...
                                <div class="row-fluid">
                                        <div class="span12">
                                            <div class="control-group">
                                                <label class="control-label"><strong>Informasi Vendor</strong></label>
                                                <div class="controls">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <label class="control-label">Code Vendor</label>
                                            <div class="controls">
                                            {{-- <input readonly="enabled" type="text" maxlength="30" id="code_project" name="code_project" value="{{ $data['content'] }}" class="span12 " /> <span style="margin:-23px 412px" class="span12"><i class="fa fa-circle text-success"></i> {{ __("Connected with izzy transport")  }}</span> --}}
                                            <input readonly="enabled" type="text" style="width:385px" id="code_project" name="code_project" value="{{ $data['content'] }}" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                      ...
                      <div class="row-fluid">
                          <div class="span6">
                              <div class="control-group">
                                  <label class="control-label"><label style="font-size: 20px; color:darkred;position:absolute">*</label>&nbsp;&nbsp;&nbsp;Nama Vendor</label>
                                  <div class="controls">
                      ...
                      <div class="row-fluid">
                          ...
                          <div class="row-fluid">
                              <div class="span6">
                                  <div class="control-group">
                                      <label class="control-label"><label style="font-size: 20px; color:darkred;position:absolute">*</label>&nbsp;&nbsp;&nbsp;No</label>
                                      <div class="controls">
                                        {{-- <div class="npwp"></div> --}}
                                          <input type="text" maxlength="20" name="tax_no" id="tax_no" style="width:385px;" />
                            ...
                            <div class="span6">
                              ...
                              <div class="span6">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <input type="text" maxlength="30" name="tax_address" style="width:385px;" id="tax_address" value="{{ old('tax_address') }}" />
                          ...
                          <div class="row-fluid">
                                  <div class="span6">
                                      <div class="control-group">
                                          ...
                                          <div class="controls" >
                                              <input type="text" style="width:385px;"  id="tax_phone" name="tax_phone" value="{{ old('tax_phone') }}" />
                                          </div>
                                      </div>
                                  </div>
                                  <div class="span6">
                      ...
                      <div class="row-fluid">
                          ...
                          <div class="row-fluid">
                              <div class="span6">
                                  <div class="control-group">
                                      <label class="control-label">No Telepon</label>
                                      <div class="controls">
                                          <input type="text" id="phone" name="phone" value="{{ old('phone') }}" style="width:385px" />
                                      </div>
                                  </div>
                              </div>
                              <div class="span6">
                        ...
                        <div class="row-fluid">
                                <div class="span12">
                                <button id="add_master_vendor" type="submit" class="btn btn-success">Save</button>
