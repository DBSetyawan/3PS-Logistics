<div class="modal fade" id="add_item_vendors" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog"
...
{{-- {{ $dx }} --}}
                            ...
                            <div class="accordion-inner">
                                    ...
                                    @if ($dx == "true")
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select class="customerload input-large m-wrap" style="width:350px" tabindex="1" id="vendorx_id" name="vendorx_id">
                                                </select>
                                        </div>
                                    </div>
                                        @else
                                        <div class="control-group">
                                            <label class="control-label" style="text-align: end">Vendor</label>
                                            <div class="controls">
                                                <input class="input-large validate[required]" readonly="enabled" type="text" style="width:345px" maxlength="30" id="vendorx" name="vendorx"/>
                                                <input class="input-large validate[required]" readonly="enabled" type="hidden" maxlength="30" id="vendorx_id" name="vendorx_id"/>
        ...
        <div style="text-align: right">
            ...
            <button id="saveitemVendors" class="btn btn-primary">Save</button>
        </div>
    </div>
    </div>
    </form>
