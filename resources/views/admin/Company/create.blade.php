            ...
            <div class="span12">
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      @endif
                        <!-- BEGIN FORM-->
                        <form action="{{ route('Companys.store') }}" class="form-horizontal" method="POST">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" maxlength="30" value="{{ old('name') }}" id="name" name="name" value="" class="span12 " />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row-fluid">
                                <div class="span12" style="text-align:right;" >
                                    <div class="form-actions" style="">
                                        ...
                                        <a class="btn btn-warning" href="{{ url('/Companys') }}">Cancel</a>
                                </div>
                            </div>
                        </div>
                </form>
