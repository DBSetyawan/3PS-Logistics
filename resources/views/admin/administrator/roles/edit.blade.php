            ...
            <div class="span12">
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      @endif
                        <!-- BEGIN FORM-->
                        <form action="{{ route('roles.update', $role->id) }}" class="form-horizontal" method="PUT">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" maxlength="30" value="{{ $role->name }}" name="name" class="span12 " />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row-fluid">
                                <div class="span6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="span12 chzn-select" name="permission[]" multiple="multiple" data-placeholder="" tabindex="1">
