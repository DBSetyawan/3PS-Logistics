            ...
            <div class="widget red">
                ...
                <div class="widget-body">
                        ...
                        <div style="text-align:right;">
                            <button type="button" class="btn btn-info" onclick="location.href='{{ route('roles.create.index', $some) }}'">
                                    <i class="icon-plus"></i>
                                    Add New
                            </button>
                        </div>
                ...
                <table class="table table-striped table-bordered {{ count($roles) > 0 ? 'datatable' : '' }} dt-select" id="sample_1">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
                        ...
                        @if (count($roles) > 0)
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="width: 16px;">
                                    <div class="span5">
                                      <button onclick="location.href='{{route('roles.edit.index', array($some, $role->id) )}}'" class="btn btn-xs btn-primary" type="button"><i class="fas fa-user-cog"></i></button>
                                    </div>
                                <form class="span6" action="{{route('destroy.role.index', array($some, $role->id) )}}" method="post">
                                    {{-- {{ method_field('DELETE') }} --}}
