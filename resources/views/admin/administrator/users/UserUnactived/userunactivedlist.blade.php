            ...
            <div class="widget red">
                ...
                <div class="widget-body">
                        ...
                        <div style="text-align:right;">
                            <button type="button" class="btn btn-primary" onclick="location.href='{{ route('users.restote.all.active', array($some)) }}'">
                ...
                <table class="table table-striped table-bordered {{ count($users) > 0 ? 'datatable' : '' }} dt-select" id="sample_1">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="width: 16px;">
                                    <div class="span5">
                                    <button onclick="location.href='{{ route('users.restored.active', array($some, $user->id)) }}'" class="btn btn-xs btn-primary" type="button"><i class="fas fa-user-cog"></i></button>
                                    </div>
                                    {{-- on progress on delete permanent users --}}
