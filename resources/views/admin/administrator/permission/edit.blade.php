...
<li>
    <a href="{{ url('permissions') }}">Edit Permission</a>
    <span class="divider">/</span>
</li>
<li class="active">
    {{ $menu}}
            ...
            <div class="span12">
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      @endif
                        <!-- BEGIN FORM-->
                        <form action="{{ route('permissions.update', $permission->id) }}" class="form-horizontal" method="PUT">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}" class="span12 " />
                          <div class="row-fluid">
                            <div class="span12">
                                <div class="control-group">
                                    <label class="control-label"><strong>Informasi Permission</strong></label>
                                    <div class="controls">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" maxlength="30" value="{{ $permission->name}}" name="name" class="span12 " />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row-fluid">
                                <div class="span12" style="text-align:right;" >
                                    <div class="form-actions" style=""   >
                                        ...
                                        <a class="btn btn-warning" href="{{ route('permissions.list.index', $some) }}">Cancel</a>
                                </div>
                            </div>
                        </div>
                      </form>
