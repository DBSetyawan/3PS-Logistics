            ...
            <div class="span12">
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      @endif
                        <!-- BEGIN FORM-->
                        <form action="{{ route('Branchs.update', $data_company->id) }}" class="form-horizontal" method="PUT">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}" class="span12 " />
                        {{-- {{ method_field('PUT') }} --}}
                          <div class="row-fluid">
                            <div class="span12">
                                <div class="control-group">
                                    <label class="control-label"><strong>Informasi Edit Branch</strong></label>
                                    <div class="controls">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" maxlength="30" value="{{ $data_company->branch }}" id="branch" name="branch" class="span12 " />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row-fluid">
                                <div class="span12" style="text-align:right;" >
                                    <div class="form-actions" style=""   >
                                        ...
                                        <a class="btn btn-warning" href="{{ route('Branchs.index') }}">Cancel</a>
                                </div>
                            </div>
                        </div>
                      </form>
