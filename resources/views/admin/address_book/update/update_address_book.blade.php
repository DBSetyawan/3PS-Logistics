...
@extends('admin.layouts.master', array('id_address_book' => session()->get('id_address_book')))
@section('head')
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      <div class="modal-footer">
                          FORM DETAIL ADDRESS BOOK: <strong> {{ $dataix->customers->name }}</strong>
                        </div>
                        <!-- BEGIN FORM-->
                <form class="form-horizontal" id="add_boo" method="POST" action="{{route('address_book.update', $dataix->id)}}">
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="controls">
                                                <select style="width:398px" class="dtcstmers validate[required]" tabindex="-1" name="customer" id="customer">
                                                    @foreach($cs as $a)
                                                        <option value="{{ $a->id }}" @if($a->id==$dataix->customer_id) selected='selected' @endif >{{ $a->name }}</option>
                                                    @endforeach()
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select style="width:398px" class="citys validate[required]" tabindex="-1" name="citys" id="citys">
                                                    @foreach($cts as $a)
                                                        <option value="{{ $a->id }}" @if($a->id==$dataix->city_id) selected='selected' @endif >{{ $a->name }}</option>
                                                    @endforeach()
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input type="text" class="input-block-level validate[required]" placeholder="Enter name" id="names" value="{{ $dataix->name }}" name="names" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input type="text" class="input-block-level validate[required]" placeholder="Empty" id="detil" value="{{ $dataix->details }}" name="detil" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls controls-row">
                                                    <input type="text" class="input-block-level validate[required]" placeholder="Enter Contact" id="contak" value="{{ $dataix->contact }}" name="contak" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls controls-row">
                                                    <input type="text" class="input-block-level validate[required]" placeholder="Enter Address" id="add_boo" value="{{ $dataix->address }}" name="add_boo" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls controls-row">
                                                        <input type="text" class="input-block-level validate[required]" placeholder="Enter Phone" id="fone" value="{{ $dataix->phone }}" name="fone" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success">Update</button>
                                <a class="btn btn-warning" href="{{ route('master.address.book', session()->get('id')) }}">Cancel</a>
                              </div>
                            </div>
                        </form>
                    </div>
