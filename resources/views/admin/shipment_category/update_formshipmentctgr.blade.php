@extends('admin.layouts.master', array('shipmentcategoriesid'=> session()->get('shipmentcategoriesid')))
@section('head')
...
<li>
    <a href="#">Shipment Category List</a>
    <span class="divider">/</span>
</li>
<li class="active">
    {{ $menu}}
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      <div class="modal-footer">
                          FORM DETAIL SHIPMENT CATEGORY: <strong>{{ $lm->nama }}</strong>
                        </div>
                        <!-- BEGIN FORM-->
                <form class="form-horizontal" id="add_item" method="POST" action="{{route('shipmentscy.update', $lm->id)}}">
                        ...
                        <br />
                            ...
                            <div class="control-group">
                                <label class="control-label" style="text-align: end">Name</label>
                                    <div class="controls">
                                        <input class="input-large" type="text" maxlength="30" name="name" value="{{ $lm->nama }}" />
                                    </div>
                                </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary">Update</button>
                            <a class="btn btn-success" href="{{ route('master.shipment.category.list', session()->get('id')) }}">Back To List</a>
                        </div>
                    </div>
                </form>
            </div>
