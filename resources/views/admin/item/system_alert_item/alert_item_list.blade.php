            ...
            <div class="widget red">
                ...
                <div class="widget-body">
                    ...
                    <table class="table table-striped table-bordered" id="sample_1">
                        ...
                        <tbody>
                          @foreach($alert_items as $item_rows)
                            <tr class="odd gradeX">
                                <td style="width: 20%;">{{ $item_rows->itemno }}</td>
                                <td style="width: 38%;">{{ $item_rows->itemovdesc }}</td>
                                <td style="width: 16%;">{{ $item_rows->price }}</td>
                                <td style="width: 16%;">{{ $item_rows->unit }}</td>
                                <td style="width: 7%;"><input type="checkbox" id="check_alert_item" name="check_alert_item[]" value="{{$item_rows->id}}"></td>
                            </tr>
                          @endforeach()
                        </tbody>
                    </table>
    ...
    if (!state==false) {
        ...
        cancelButtonText: 'Batal'
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ url('/alert-item-update') }}/"+id_item,
                    dataType: "json",
                    data: {
                        id:id_item,
                        flag:flag,
