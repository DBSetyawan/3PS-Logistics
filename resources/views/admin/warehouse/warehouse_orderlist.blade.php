                     ...
                     <div style="text-align:right;">
                                ...
                                {{-- <form action="{{ route('xml.files.http.only', array($some)) }}"> --}}
                                        {{-- @can('operasional') --}}
                                            <div class="span4">
                                                <div class="control-group span12">
                                                    <div class="controls" style="margin-left:620px;margin-top: -39px;">
                                                        <div class="input-prepend">
                                        ...
                                        {{-- @endcan --}}
                                            ...
                                            <table class="table table-striped table-bordered table-striped" id="warehouse-table">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Order ID</th>
...
<script type="text/javascript">
  ...
  $('#warehouse-table').DataTable({
        ...
        columns: [
            ...
            {data: 'no_doc_customer', name: 'no_doc_customer'}
        ]
    });
});
