...
<!DOCTYPE html>
<html lang="en">
  {{-- https://github.com/fengyuanchen/viewerjs#syntax --}}
<head>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="{{ asset('css/viewers/main-view.css') }}">
</head>
<body>
  <!--[if lt IE 9]>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbar-collapse" role="navigation">
        <ul class="nav navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="https://github.com/fengyuanchen/viewerjs/blob/master/README.md" data-toggle="tooltip" title="View the documentation">Docs</a>
          </li>
  ...
  <div class="jumbotron bg-primary text-white rounded-0">
    <div class="container">
      <div class="row">
        <div class="col-md">
          <h1>Viewer.js <small class="h6">v1.5.0</small></h1>
      ...
      <div class="col-sm-8 col-md-6">
        ...
        <div class="docs-galley mb-3">
          <ul class="docs-pictures clearfix">
            <li><img data-original="/img/3PE.png" src="/img/3PE.png" alt="Cuo Na Lake"></li>
          </ul>
        </div>
      </div>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <nav class="nav flex-wrap justify-content-center mb-3">
        ...
        <a class="nav-link" href="https://github.com/fengyuanchen/viewerjs/blob/master/LICENSE">License</a>
  ...
  <script src="{{ asset('js/viewers-main.js') }}"></script>
</body>
</html>
