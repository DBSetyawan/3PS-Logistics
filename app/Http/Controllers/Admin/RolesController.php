...
class RolesController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreRolesRequest $request, $branch_id)
    {
        // if (! Gate::allows('users_manage')) {
        //     return abort(401);
        // }
        ...
        $alert_items = Item::where('flag',0)->get();
        $alert_customers = Customer::with('cstatusid')->where('flag',0)->get();
        return redirect()->route('roles.list.index', $branch_id);
    ...
    public function editRoles($branch_id, $id)
    {
        // if (! Gate::allows('administrator')) {
        //     return abort(401);
        // }
    ...
    public function destroyRoles($branch_id, $id)
    {
        // if (! Gate::allows('users_manage')) {
        //     return abort(401);
        // }
