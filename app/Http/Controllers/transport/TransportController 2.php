        ...
        try
            {
                ...
                $response = $client->get('http://api.trial.izzytransport.com/customer/v1/project',
                    [  'headers' => [
                                ...
                                [
                                    'headers' => [
                                        ...
                                        'Accept' => 'application/json'
                                                        ...
                                                        'form_params' => [
                                                            'Sh[projectId]' => $dataAsyncTransports['id_project'],
                                                            'Sh[vendorId]' => '10',
                                                            'Sh[poCodes]' => '',
...
//                                                         //Prepare you post parameters
    ...
    public function show($branch_id, $id)
    {
        ...
        $jobs_order_idx = self::generateID();
            ...
            if ($testing[0]['check_is'] == "api_izzy") {
                ...
                //                         'http://api.trial.izzytransport.com/customer/v1/vendor',
                //                         [  'headers' => [
                //                                 'Content-Type' => 'application/x-www-form-urlencoded',
                //                                 'X-IzzyTransport-Token' => '59ee16a121cc8dac757ed21427d3d7e8fd19b501.1552632085',
                //                                 'Accept' => 'application/json'],
                ...
                //                     'http://api.trial.izzytransport.com/customer/v1/project',
                //                     [  'headers' => [
                //                             'Content-Type' => 'application/x-www-form-urlencoded',
                //                             'X-IzzyTransport-Token' => '59ee16a121cc8dac757ed21427d3d7e8fd19b501.1552632085',
                //                             'Accept' => 'application/json'],
                ...
                //                     'http://api.trial.izzytransport.com/customer/v1/shipment',
                //                     [  'headers' => [
                //                             'Content-Type' => 'application/x-www-form-urlencoded',
                //                             'X-IzzyTransport-Token' => '59ee16a121cc8dac757ed21427d3d7e8fd19b501.1552632085',
                //                             'Accept' => 'application/json'],
                ...
                try
                    {
                        $transport_list = Transport_orders::with('customers')->find($id);
                        $client = new Client(['auth' => ['samsunguser', 'asdf123']]);
                        $response = $client->get('http://api.trial.izzytransport.com/customer/v1/shipment',
                            [  'headers' => [
                                    'Content-Type' => 'application/x-www-form-urlencoded',
                                    'X-IzzyTransport-Token' => 'ab567919190b1b8df2b089c02e0eb3321124cf6f.1575862464',
                                    'Accept' => 'application/json'],
    ...
    {
        // dd($request->saved_destination);die;
        ...
        if ($testing[0]['check_is'] == "api_izzy") {
            ...
            if ($testing[0]['operation'] == "true") {
                ...
                try {
                    ...
                    $response = $client->post('http://api.trial.izzytransport.com/customer/v1/shipment/update', [
                        'headers' => [
                            'Content-Type' => 'application/x-www-form-urlencoded',
                            'X-IzzyTransport-Token' => 'ab567919190b1b8df2b089c02e0eb3321124cf6f.1575862464',
                            'Accept' => 'application/json'
                ...
                $client2 = new Client(['auth' => ['samsunguser', 'asdf123']]);
                $response2 = $client2->get('http://api.trial.izzytransport.com/customer/v1/project',
                    [  'headers' => [
                            'Content-Type' => 'application/x-www-form-urlencoded',
                            'X-IzzyTransport-Token' => 'ab567919190b1b8df2b089c02e0eb3321124cf6f.1575862464',
                            'Accept' => 'application/json'],
                ...
                $client1 = new Client(['auth' => ['samsunguser', 'asdf123']]);
                $response1 = $client1->get('http://api.trial.izzytransport.com/customer/v1/shipment',
                    [  'headers' => [
                            'Content-Type' => 'application/x-www-form-urlencoded',
                            'X-IzzyTransport-Token' => 'ab567919190b1b8df2b089c02e0eb3321124cf6f.1575862464',
                            'Accept' => 'application/json'],
                    ...
                    if ($request->customers_name == null || $data_origin == null && $data_destination == null || $request->sub_servicess == null && $request->items_tc == null) {
                        ...
                        // $izzytransports = json_decode($response->getBody()->getContents(), true);
                        ...
                        $SalesOrders__ = new Promise(
                            function () use (&$SalesOrders__, &$responseCODESO, &$responseGeneratePO, &$qtys, &$Comments, &$rts) {
                                $SalesOrders__->resolve($this->UpdateSyncSO($responseCODESO, $responseGeneratePO, $qtys, $Comments, $rts));
                        ...
                        // $this->UpdateSyncBarangJasa($itemID_accurate, $Qty, $Cost);
                            
                        // $this->UpdateSyncSQ($responseCODESQ, $request->input('qty'), $request->input('rate'), $Comments);
                    
                        // $this->UpdateSyncSO($responseCODESO, $responseGeneratePO, $request->input('qty'), $Comments, $request->input('rate'));
                        ...
                        return response()->json([
                            ...
                            // 'order_id' => $transports_->order_id,
                            'izzyTransports' => 'Update shipment success - '.'['.$Izzy->wait()["Shipment"]["code"].']',
                            // 'izzy-Transports' => $Izzy->wait()["message"].'['.$Izzy->wait()["Shipment"]["code"].']',
                            'BarangJasa' => $barangJasa__->wait()->original["d"][0].'.',
                            'SOrders' => $SalesOrders__->wait()->original["d"][0].'.'
                        ]);

                        // connectify('success', 'Accurate Cloud', 'Transaksi berhasil Update Qty di Barang,SQ,SO');
                        // return redirect()->route('transport.show.detail.transaction', ['branch_id' => session()->get('id'), 'id' => $encrypts]);
            ...
            if ($testing[0]['operation'] == "false") {
                ...
                //             'alert_customers' => $alert_customers])
                //             ->with(compact(['data_array2','prefix','data_array1','transport_list','data_transport',
                //             'customers','address','global_city','global_sub_services'
                //             ])
                //     );
    ...
    $decrypts= Crypt::decrypt($id);
    $data_transport = Transport_orders::with('customers','itemtransports.sub_services','company_branch.company')->where('company_branch_id', [$branch_id])->where('order_id','=',$decrypts)->first();
    ...
    $customPaper = array(0,0,840.00,596.80);
        $data = ['name' =>'3 permata system'];
            $pdf = PDF::loadView('admin.transport.report_transports.transport_reports', compact('qrCode','data','data_transport'));
