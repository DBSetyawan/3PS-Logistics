                     ...
                     foreach($fetchBatchItemOrderDetail as $key => $thisdataBatchItemTransports){
                       ...
                       foreach($fetch_data as $key => $thisDataTransports){
                          ...
                          */
                          ...
                          $customerId = (Int) $thisDataTransports->customers["id"];
                        ...
                        // $client = new Client();
                        $userWithToken = Customer::findOrFail($customerId);
                        ...
                        $timer = $loop->addPeriodicTimer(1, \Closure::bind(function () use (&$timer) {
                            ...
                            $client = new Client(['handler' => HandlerStack::create($handler), 'base_uri' => 'http://your.api.vendor.com/customer/v1/']);
                            ...
                            $response[] = $client->postAsync(
                                    ...
                                    [
                                        ...
                                        [
                                            ...
                                            'Sh[vendorId]' => '8', // remember this manually, check your request from matching API izzy and form order
                                            'Sh[poCodes]' => '',
                                            'Sh[collie]' => $Collie,
                        ...
                        // dd($sending,$userWithToken->userWithToken);die;
                        $ShipmentCode = $sending[0]["value"]->original["Shipment"]["code"]; // projectId Izzy.
                        ...
                        $AccurateCloudSalesOrders = $this->openModulesAccurateCloud
                            ->FuncOpenmoduleAccurateCloudSaveSalesOrders(
                                'SO.'.$ShipmentCode,
                                session('UserMultiBranchAccurate')["d"][0]["id"], //Surabaya
                                $dataARRXCUSTOMER[0],
                                // $dataARRXITEMTRANSPORT[0],
                        ...
                        // dd($AccurateCloudSalesOrders, session('sessionID_accurate'), session('AccountAccurate'), session('UserMultiBranchAccurate')["d"][0]["id"]);
