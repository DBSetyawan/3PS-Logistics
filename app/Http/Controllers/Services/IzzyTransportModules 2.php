...
use warehouse\Jobs\JRSWebhookCreated;
...
use warehouse\Jobs\HVVBNWebhookTransport;
...
class IzzyTransportModules extends Controller implements IzzytransportsHooks
{
    ...
    public function ProcessingResponse(Transport_orders $tc, $response, $shipment_code){
        ...
        if($response == "CREATE"):
            ...
            HVVBNWebhookTransport::dispatch($shipment_code, Auth::User()->id);
        ...
        if($response == "POD"): 
                ...
                JRSWebhookCreated::dispatch($shipment_code, Auth::User()->id);
                ...
                if($checkAsync == true):
                    ...
                    $tc->whereIn('order_id', [$order_id[0]])->update(
                        ...
                        ;
                            ...
                            return response()->json(["response" => "Data tidak terhubung dengan accurate"]);
    ...
    public function ReSyncAccurate(Transport_orders $tc, $shipment_code){ 
        ...
        if($checkStatusShipment['status_order_id'] == 8):
                ...
                //     else:
                    $AccurateBranchId = $this->openModulesAccurateCloud->FuncOpenmoduleAccurateCloudUsersBranchId()["d"][0]["id"];
                    $AccurateBranchName = $this->openModulesAccurateCloud->FuncOpenmoduleAccurateCloudUsersBranchId()["d"][0]["name"];
                            ...
                            // return response()->json(["response" => $AccurateCloudSalesOrders]);
                            ...
                            : [];
                                ...
                                $checkAsync = collect($CEKSQ)->isEmpty();
                                    ...
                                    if($checkAsync == true):
                                                ...
                                                $tc->whereIn('order_id', [$order_id[0]])->update(
                                                    [
                                                        'salesOrders_cloud' => 'SO.'.$order_id[0],
                                                        'sync_accurate' => "false"
                                                    ]
                                                ) 
                                            ;
                                            ...
                                            return response()->json(["response" => "Data berhasil terhubung dengan accurate", "success" => "true"]);   
                                            // return response()->json(["response" => "Data berhasil terhubung dengan accurate"]);
                                            // return response()->json(["response" => $order_id[0]]);
